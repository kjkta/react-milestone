...
function renderMilestone(m, { Milestone, CurrentMilestone, CompletedMilestone, onMilestoneClick, vertical, }) {
    return (createElement("div", { key: m.index, style: {
            position: "absolute",
            ...(vertical
                ? {
                    left: "50%",
...
const ProgressBar = ({ children, percentage = 0, milestoneCount = 0, milestoneWidth = 15, color = "green", vertical, style = {}, transitionSpeed = 0, Milestone, CurrentMilestone, CompletedMilestone, onMilestoneClick, }) => {
    ...
    return children ? (children({
        ...
        completedBarStyles,
        milestoneElements,
    })) : (createElement("div", { style: containerStyles },
        createElement("div", { style: completedBarStyles }),
